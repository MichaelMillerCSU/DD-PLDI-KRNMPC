...
rank(ctrb(LDI_Koopman_Min(1:n, 1:n), LDI_Koopman_Min(1:n, n + 1: n + m)))
...
A{Nd_temp + 1} = diag(1e-8 * ones(n, 1));
...
% x = [1; -1];
[K_Static, nosolution_flag, Q, gamma, P_Static, mu_static] = getOptimalGain([0.5 ; -0.8], A(1: Nd), B(1: Nd), d);
